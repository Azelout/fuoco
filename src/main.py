...
seuil = 0.15
# model_name = f"fuoco_0_0_{get_config('MODEL_VERSION')}.keras"
...
### Image aléatoire parmis le Dataset
# # Chemin de l'image à prédire
# img_folder = ["candle_on"]
...
### Image choisie à l'avance:
img = "test_1"
image_path = f'../data/val/{img}.jpg'  # Remplace par le chemin de ton image
...
def affichage_resultat1(image_path): # Afficher l'image d'origine et le masque prédit
...
def affichage_resultat2(predicted_mask_resized, original_image):
...
affichage_resultat2(predicted_mask_resized, original_image)
